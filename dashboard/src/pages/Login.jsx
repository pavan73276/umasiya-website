    ...
    <div className="flex flex-col lg:flex-row h-screen">
      ...
      <div className="flex-1 flex justify-center items-center bg-white">
        <div className="bg-white p-8 w-full max-w-lg rounded-xl shadow-2xl">
          <h2 className="text-3xl lg:text-4xl font-bold mb-4 text-center text-teal-900">
            Welcome
          </h2>
          <p className="text-gray-600 mb-6 text-center">
            Please login to Admin or Staff Dashboard
          </p>
          ...
          <div className="flex justify-between gap-4">
            <button
              ...
              className="w-1/2 bg-teal-600 hover:bg-teal-500 text-white font-semibold py-3 rounded-lg transition"
            >
              Admin Login
            </button>
            <button
              onClick={handleStafflogin}
              className="w-1/2 bg-orange-600 hover:bg-orange-500 text-white font-semibold py-3 rounded-lg transition"
            >
              Staff Login
            </button>
          </div>
